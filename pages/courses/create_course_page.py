...
from components.courses.create_course_exercises_toolbar_view_component import CreateCourseExercisesToolbarView
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_exercises_toolbar_view = CreateCourseExercisesToolbarView(page)
